...
class PipelineDefinition:
    ...
    def __init__(self, definition: Dict[str, Any]):
        ...
        try:
            ...
            if hasattr(e, "__module__") and "jsonschema" in e.__module__:
                ...
                raise PipelineValidationError(f"Error validating pipeline definition: {e}")
        ...
        try:
            ...
            for node in definition.get("nodes", []):
                ...
                if "agent_name" not in node:
                    raise PipelineValidationError(f"Node {node.get('id', '(unnamed)')} is missing required field: agent_name")
    ...
    def _validate_dependencies(self, definition: Dict[str, Any]):
        ...
        try:
            ...
            raise PipelineValidationError(f"Cycle detected in pipeline dependencies: {e}")
