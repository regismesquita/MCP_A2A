    ...
    return {
        ...
        "nodes": [
            ...
            },
            {
                ...
                "agent_name": "analyzer",
                "inputs": {
                    "data": {"source_node": "preprocess", "source_artifact": "processed_data"}
                }
            },
            {
                "id": "visualize", 
                ...
                "inputs": {
                    "data": {"source_node": "analyze", "source_artifact": "analysis_results"}
                }
            },
            {
                "id": "report", 
                "agent_name": "reporter",
                "inputs": {
                    "analysis": {"source_node": "analyze", "source_artifact": "analysis_results"},
                    "visuals": {"source_node": "visualize", "source_artifact": "visualizations"}
                }
            }
        ],
