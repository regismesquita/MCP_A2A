...
class MockA2AAgent:
    ...
    def get_client_mock(self):
        ...
        # Configure methods
        for method in [
            "send_message", "send_message_streaming", "send_input", 
            "cancel_task", "get_agent_card"
        ]:
            setattr(client, method, AsyncMock(side_effect=lambda *args, method=method, **kwargs: 
                                             record_call(method, *args, **kwargs)))
